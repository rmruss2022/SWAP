...
const AddCRN = () => {
  return (
    <div className='flex-col mb-3 border-[gray-100] border-2 rounded-xl p-3'>
        ...
        <div className='flex gap-2 justify-between mb-5 p-3 border border-indigo-600 rounded-xl md:w-[500px] w-full'>
            <div className='flex'>
                <p className='text-md font-mono text-[green]'>CRN:</p>
                <p className='text-md font-mono'>13118, CS3714, Cloud Computing</p>
            </div>
            <div>
                <FaTrash className='text-xl text-[red] cursor-pointer' />
            </div>
